...
```
    ...
    ## Sampling took (0.024, 0.021, 0.024, 0.022) seconds, 0.091 seconds total
    ## 
...
```
    ...
    ## 4 chains: each with iter=1000; warmup=1000; thin=1; 1000 iterations saved.
    ## 
    ## Warmup took (0.016, 0.014, 0.015, 0.015) seconds, 0.060 seconds total
    ## Sampling took (0.026, 0.023, 0.025, 0.025) seconds, 0.099 seconds total
    ## 
    ##                  Mean     MCSE  StdDev    MAD    5%    50%   95%  ESS_bulk  ESS_tail  R_hat
    ## 
