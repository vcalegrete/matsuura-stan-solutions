...
and display the model summary. I had to play around with <tt>seed</tt>
until finding one that didn’t initialize $\sigma$ at 0. Also, I
suppressed the chain iteration updates with <tt>refresh = 0</tt> once I
found a good seed.
...
```
    ...
    ## 
    ## Warmup took (0.016, 0.014, 0.013, 0.014) seconds, 0.057 seconds total
    ## Sampling took (0.025, 0.022, 0.024, 0.022) seconds, 0.093 seconds total
    ## 
...
$$
\begin{align}
Y_1|\mu_1,\sigma&\sim N(\mu_1,\sigma_1^2)\\
Y_2|\mu_2,\sigma&\sim N(\mu_2,\sigma_2^2)
\end{align}
$$
...
```
    ...
    ## Sampling took (0.025, 0.024, 0.024, 0.026) seconds, 0.099 seconds total
    ## 
    ##                  Mean     MCSE  StdDev    MAD    5%    50%   95%  ESS_bulk  ESS_tail  R_hat
    ## 
